          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 ftco-animate">
    				<form action="{{url('/index')}}" method="post" class="appointment-form">
                        @csrf
	            <div class="row">
	              <div class="col-sm-6">
	                <div class="form-group">
			              <input type="text" name='name' class="form-control" id="appointment_name" placeholder="Name" value="{{old('name')}}">
                          @error('name')
                            {{$message}}
                          @enderror
			            </div>
	              ...
	              <div class="col-sm-6">
	                <div class="form-group">
			              <input type="email" name='email' class="form-control" id="appointment_email" placeholder="Email" value="{{old('email')}}">
                          @error('email')
                            {{$message}}
                          @enderror
			            </div>
	              ...
	              <div class="col-sm-6">
	                <div class="form-group">
	                  <input type="date" name='date' class="form-control appointment_date" placeholder="Date" value="{{old('date')}}">
                      @error('date')
                            {{$message}}
                          @enderror
	                </div>
	              ...
	              <div class="col-sm-6">
	                <div class="form-group">
	                  <input type="time" name='time' class="form-control appointment_time" placeholder="Time" value="{{old('time')}}">
                      @error('time')
                            {{$message}}
                          @enderror
	                </div>
	              ...
	              <div class="col-sm-6">
	                <div class="form-group">
                      ...
                      <select name="work" id="" class="form-control" value="{{old('work')}}">
	              ...
	              <div class="col-md-12">
	              	<div class="form-group">
		                <textarea name="message" id="" cols="30" rows="7" class="form-control" placeholder="Message" value="{{old('message')}}"></textarea>
                        @error('message')
                            {{$message}}
                          @enderror
		              </div>
